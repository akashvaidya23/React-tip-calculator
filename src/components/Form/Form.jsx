        ...
        <>
            <div style={{ marginBottom: '50px' }}>
                ...
                <div className={styles.amt}>
                    <Label name="Enter your bill amount."
                ...
                <div className='container' style={{ marginTop: '50px', border: '1px solid black', padding: '20px' }}>
                    <div className="row align-items-start">
                        <div className='col' style={{ textAlign: "center" }}>
                            ...
                            <Dropdown
                                value={service}
                                serviceChangeHandler={serviceChange}
                        ...
                        <div className='col' style={{ textAlign: "center", justifyContent: 'center', marginTop: '10px' }}>
                            <Buttons text="Add Customer"
                                clickHandler={btnClick} color="danger" />
                        </div>
                    </div>
                </div>
                ...
                <div style={{ textAlign: 'center', marginTop: '25px' }}>
                    <Buttons
                        text="Calculate tip and Customer"
                        color="primary"
                        clickHandler={totalBtnclick} />
                </div>
                <div className='container' style={{ border: '1px solid black', textAlign: "center", marginTop: '25px', justifyContent: 'center' }}>
                    <TotalData
                        amount={`The total tip is ${totalAmt}`}
                        cust={`Total no of customers ${totalCustomers}`} />
                </div>
            </div>
        </>
    );
